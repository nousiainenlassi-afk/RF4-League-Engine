"""Team selection helpers for RF4 League Engine."""
...
class TeamSelector:
    ...
    def select_players(self, players: List[Player], team_name: str) -> List[Player]:
        ...
        The selector filters players by the requested team, sorts them by
        descending total points, and returns up to eight players.
        ...
        Returns:
            A list of selected Player objects.
        """
